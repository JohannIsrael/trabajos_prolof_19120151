...
%el _ es una cadena que acepta todo, por lo tanto se debe poner hasta abajo para que pueda leer las demas
...
template([please, s(_), _], ['No', no, puedo, ayudarte, ',', yo, soy, solo, una, maquina], []). 
